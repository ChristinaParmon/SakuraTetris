...
public class Block {
    ...
    private int frameNumber;//кол-ве фреймов
    private BlockColor color;
    private Point position;//текущая пространственная позиция в поле игры
    ...
    private Block(int shapeIndex, BlockColor blockColor){
        ...
        this.position = new Point(FieldConstants.COLUMN_COUNT.getValue()/2,0);//125
    }
